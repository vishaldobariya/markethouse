...
$pagination = ( !empty( $instance['show_pagination'] ) && ( $instance['show_pagination'] == 'yes' ) || $instance['show_pagination'] == '1') ? 1 : 0;
...
if ( $our_team->have_posts() ) {
	...
	$html .= '<div class="thim-crypto-team-carousel" data-visible="' . $columns . '" data-desktopsmall="3" data-itemtablet="2" data-navigation="1" data-pagination="' . $pagination . '" >';
	while ( $our_team->have_posts() ): $our_team->the_post();
		...
		$html .= '<div class="our-team-image"><a class="link-img" href="' . esc_url( get_permalink() ) . '"></a> ' . thim_get_feature_image( get_post_thumbnail_id(), 'full', apply_filters( 'thim_member_thumbnail_width', 260 ), apply_filters( 'thim_member_thumbnail_height', 383 ) );
		$html .= '</div>';
		$html .= '<div class="content-team">';
		$html .= '<div class="content-team-box">';
	...
	$html .= 'jQuery(".thim-crypto-team-carousel").each(function() {
